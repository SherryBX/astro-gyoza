...
function convertDates(comment) {
  if (comment.insertedAt) {
    comment.insertedAt = new Date(comment.insertedAt).getTime()
  }
  if (comment.createdAt) {
    comment.createdAt = new Date(comment.createdAt).getTime()
  }
  if (comment.updatedAt) {
    comment.updatedAt = new Date(comment.updatedAt).getTime()
  }
  return comment
}
